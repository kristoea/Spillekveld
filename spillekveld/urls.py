...
urlpatterns = [
    ...
    path('midgardcon/skrivekonkurranse/', ProgramView.as_view(template_name="skrivekonkurranse.html"), name="skrivekonkurranse"),
    path('midgardcon/midgardconprogram/', ProgramView.as_view(template_name="midgardconishprog.html"), name="midgardconprogram"),
